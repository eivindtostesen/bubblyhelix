#########################
#
#    Bubblyhelix - BlakeDelcourt98.pm
#
...
# This is the parameter set from R. D. Blake and S. G. Delcourt (1998): Thermal stability of DNA. Nucl. Acids Res. 26, 3323-3332.
# They assumed the values of d and alpha and then fitted sigma to data
...
($d, $sigma, $alfa)=(1,1.26e-5,1.75); # loop entropy parameters
